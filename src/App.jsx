...
import MarketplaceApiIntegration from './components/MarketplaceApiIntegration';
import MobileAppDesignDrawer from './components/MobileAppDesignDrawer';
import GardenDesignSystem from './components/GardenDesignSystem';
    ...
    <BrowserRouter>
      ...
      <main>
        <Routes>
          ...
          <Route path="/marketplace-api" element={<MarketplaceApiIntegration />} />
          <Route path="/mobile-app" element={<MobileAppDesignDrawer />} />
          <Route path="/design-system" element={<GardenDesignSystem />} />
