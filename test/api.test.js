...
describe('orders API', () => {
  it('createOrder calls POST /orders with skillId', async () => {
    ...
    expect(mockAdapter).toHaveBeenCalledWith('/orders', { skillId: 's1' });
  ...
  it('listMyOrders calls GET /orders/my-orders', async () => {
    ...
    expect(mockAdapter).toHaveBeenCalledWith('/orders/my-orders');
  ...
  it('getOrder calls GET /orders/:id', async () => {
    ...
    expect(mockAdapter).toHaveBeenCalledWith('/orders/5');
  ...
  it('updateOrderStatus calls PATCH /orders/:id/status', async () => {
    ...
    expect(mockAdapter).toHaveBeenCalledWith('/orders/3/status', { status: 'completed' });
...
describe('payments API', () => {
  it('createPayment calls POST /payments', async () => {
    ...
    expect(mockAdapter).toHaveBeenCalledWith('/payments', { orderId: 1 });
  ...
  it('verifyPayment calls POST /payments/:id/verify', async () => {
    ...
    expect(mockAdapter).toHaveBeenCalledWith('/payments/p1/verify');
  ...
  it('getPaymentHistory calls GET /payments/history/:orderId', async () => {
    ...
    expect(mockAdapter).toHaveBeenCalledWith('/payments/history/1');
...
describe('users API', () => {
  it('getProfile calls GET /users/me', async () => {
    ...
    expect(mockAdapter).toHaveBeenCalledWith('/users/me');
  ...
  it('updateProfile calls PATCH /users/me with data', async () => {
    ...
    expect(mockAdapter).toHaveBeenCalledWith('/users/me', { name: 'B' });
  ...
  it('getSettings calls GET /users/me/settings', async () => {
    ...
    expect(mockAdapter).toHaveBeenCalledWith('/users/me/settings');
  ...
  it('updateSettings calls PATCH /users/me/settings', async () => {
    ...
    expect(mockAdapter).toHaveBeenCalledWith('/users/me/settings', { orderUpdates: false });
